    ...
    <div>
      <DivContainer>
        ...
        <CaixaLogin>
          ...
          <SpanTermos>
            Ao continuar, você concorda com as <strong>Condições de Uso</strong>{" "}
            da Amazon. Por favor verifique a{" "}
            <strong>Notificação de Privacidade</strong>,
            <strong>Notificação de Cookies</strong> e a{" "}
            <strong>Notificação de Anúncios Baseados em Interesse</strong>.
          </SpanTermos>
